...
export const scoresKeys = () => {
    return 'ones twos threes fours fives sixes three-of-a-kind four-of-a-kind full-house small-straight large-straight chance yatzy'.split(' ');
}

export const scoresKeysUpper = () => {
...
const forYatzy = values => hasNOfAKind(values, 5) ? 50 : 0; 
const forChance = sum;
...
export const isYatzy = values => hasNOfAKind(values, 5);

export const scoreDiceFor = (key, values) => {
    const lookup = {
        "ones": forOnes,
        "twos": forTwos,
        "threes": forThrees,
...
export const calculateTotalledScores = (scores) => {
